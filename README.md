...
[Animated fireworks logo](https://policyengine.github.io/july4-2026/) — sequel to [halloween-2025](https://github.com/PolicyEngine/halloween-2025).

## Videos

- `videos/fireworks-silent.mp4` — 7.5 s loop, 1080p, 30 fps, silent
...
3. `tools/render-frame.sh` renders all 225 frames as parallel `chrome --headless --screenshot` runs; ffmpeg assembles them.
