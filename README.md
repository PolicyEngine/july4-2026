...
- `videos/fireworks-silent.mp4` — 11 s loop, 1080p, 30 fps, silent
...
3. `tools/render-frame.sh` renders all 330 frames as parallel `chrome --headless --screenshot` runs; ffmpeg assembles them.
